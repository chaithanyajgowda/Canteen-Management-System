      ...
      <div className="container-menu mt-5">
        <div className="row">
          ...
          <div className="col-12 mb-3">
            <div className="card">
              <div className="d-flex align-items-center">
                <img src="https://th.bing.com/th/id/OIP.21XG1xTLOPD5KUE5jbEtUQHaGU?w=211&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7" className="card-img-top" alt="Dessert" />
                <div className="card-body">
          ...
          <div className="col-12 mb-3">
            <div className="card">
              <div className="d-flex align-items-center">
                <img src="https://th.bing.com/th?id=OIP.8iLVyVDaePRtm8ryNhLkHQHaEo&w=316&h=197&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2" className="card-img-top" alt="Salads" />
                <div className="card-body">
